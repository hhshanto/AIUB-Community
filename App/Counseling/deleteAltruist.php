...
$sl=$_GET['SL'];
$user=loadAltruist($sl);

if(isset($_POST['YES']))
{
  echo "string";
  $result=removeAltruist($sl);
            if($result){
                header("Location:Altruists.php");
            }
}
...
<body>
  ...
  <table width="100%" border="2" align="center">
    ...
    <tr>
      ...
      <td colspan="3" align="center" style="background-color:Tomato; text-align: center;"><h1>Altruist Remove</h1></td>
      ...
      <div align="center" class="myDiv" >
        ...
        <div align="center">
          <table>
            ...
            <tr>
              <td height="30">
                <font size="5" > Perferred Course: &nbsp&nbsp&nbsp</font>
              </td>
              <td colspan="3">
                <label><?=$user['PreCourse']?></label> 
            ...
            <tr>
              <td>
              <input style="width: 65px;" type="Submit" name="YES" value="YES">
              </td>
              <td> 
                <a href='Altruists.php' style="text-decoration: none; color: green;">NO</a>
              </td>
            </tr>
